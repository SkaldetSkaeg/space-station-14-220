...
public abstract partial class GameTicker
{
    ...
    /// <summary>
    /// Records lifecycle transitions before rule handlers can synchronously end or delete the entity.
    /// Server implementations may retain this information for authorized administrators.
    /// </summary>
    protected virtual void RecordGameRuleAdded(EntityUid rule) { }

    /// <inheritdoc cref="RecordGameRuleAdded"/>
    protected virtual void RecordGameRuleStarted(EntityUid rule) { }

    /// <inheritdoc cref="RecordGameRuleAdded"/>
    protected virtual void RecordGameRuleEnded(EntityUid rule, GameRuleEndReason reason = GameRuleEndReason.Unknown, string? endedBy = null) { }
    ...
    /// </summary>
    [PublicAPI]
    public bool EndGameRule(Entity<GameRuleComponent?> rule, GameRuleEndReason reason = GameRuleEndReason.Unknown, string? endedBy = null)
    {
        ...
        RecordGameRuleEnded(rule, reason, endedBy);

...
public sealed partial class AdminGameRulePickerWindow : FancyWindow
{
    ...
    private StationEventCategory? _eventCategory;
    ...
    public AdminGameRulePickerWindow()
    {
        ...
        {
            _eventCategory = args.Id == AllEventCategoriesId ? null : (StationEventCategory)args.Id;
    ...
    {
        List<StationEventCategory> categories =
        [
            .. _rules.Where(rule => rule.Category == AdminGameRuleCategory.Events)
                .Select(rule => rule.EventCategory).Distinct().OrderBy(category => category)
        ];
    ...
    private void AddGroupHeading(AdminGameRuleCategory category, StationEventCategory eventCategory)
    {

...
# Implants
uplink-night-vision-implanter-name = Имплант ночного видения
uplink-night-vision-implanter-desc = Позволяет включать ночное зрение, не занимая слот очков. Яркий свет засвечивает изображение.

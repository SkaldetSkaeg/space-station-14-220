...
cult-yogg-building-cant-erase-non-cultists-buildings = Вы можете разбирать только постройки культа.
cult-yogg-building-cant-capture-cult-building = Эта постройка уже принадлежит культу.
cult-yogg-building-cant-capture-this-building = Вы не можете захватить эту постройку.
cult-yogg-building-caprure-cooldown = Захват будет доступен через { $time } с.

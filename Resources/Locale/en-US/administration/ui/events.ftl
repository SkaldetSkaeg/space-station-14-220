...
admin-events-add-all-events = All events
...
admin-events-current-events = Current events
admin-events-history = Event history
admin-events-history-hint = Events added this round, newest first, including cancelled starts. Times are measured from round start. Ended means the GameRule finished; its effects may remain.
admin-events-history-empty = No events have been added this round.
...
admin-events-history-reason-deleted = Event entity deleted

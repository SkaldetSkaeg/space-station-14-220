...
lobby-state-background-nukeart-title = Nuke

lobby-state-background-defaultrndshift-title = Default R&D shift
lobby-state-background-defaultrndshift-artist = Gabka
...
lobby-state-background-secgraduating-title = Security Graduating
lobby-state-background-secgraduating-artist = NORKA

lobby-state-background-sevastopol-title = Sevastopol
lobby-state-background-sevastopol-artist = NORKA

lobby-state-background-syndiland-title = SyndiLand
lobby-state-background-syndiland-artist = Doner2119

lobby-state-background-cardshowdown-title = Card showdown
lobby-state-background-cardshowdown-artist = Gabka

lobby-state-background-papersplease-title = Papers Please
lobby-state-background-papersplease-artist = MadSkaven

lobby-state-background-glorytonanotrasen-title = Glory to NanoTrasen
lobby-state-background-glorytonanotrasen-artist = MadSkaven

lobby-state-background-younoyou-title = You - no you
lobby-state-background-younoyou-artist = MefedronEnjoyer

lobby-state-background-kuorycap-title = Captain Kuory
lobby-state-background-kuorycap-artist = masleena

lobby-state-background-camping-title = Camping
lobby-state-background-camping-artist = btb_mitw

lobby-state-background-btb-title = No ERP
lobby-state-background-btb-artist = btb_mitw

lobby-state-background-multiverse-title = Multiverse
lobby-state-background-multiverse-artist = NORKA

lobby-state-background-undergate-title = Undergate
lobby-state-background-undergate-artist = NORKA

lobby-state-background-mousekiller-title = Mouse Killer
lobby-state-background-mousekiller-artist = honk_mother
